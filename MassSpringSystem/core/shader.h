...
public:
	...
	// ------------------------------------------------------------------------
	void setMat4(const std::string& name, const glm::mat4& mat,const bool flag = GL_FALSE) const
	{
		glUniformMatrix4fv(glGetUniformLocation(ID, name.c_str()), 1, flag, &mat[0][0]);
	}
