...
# Load data
signal_1 = pd.read_csv('Results/perturbation/outputsignal_washout.csv',header=None)
target_f_1 = pd.read_csv('Results/perturbation/targetsignal_washout.csv',header=None)

signal_2 = pd.read_csv('Results/perturbation/outputsignal_two_washout.csv',header=None)
target_f_2 = pd.read_csv('Results/perturbation/targetsignal_two_washout.csv',header=None)

signal_3 = pd.read_csv('Results/perturbation/outputsignal_three_washout.csv',header=None)
target_f_3 = pd.read_csv('Results/perturbation/targetsignal_three_washout.csv',header=None)

feedback_signal = pd.read_csv('Results/perturbation/targetsignal_washout.csv',header=None)

merged = pd.read_csv('Results/perturbation/merged_test_output.csv',header=None)
merged_openloop = pd.read_csv('Results/perturbation/merged_feedback.csv',header=None)
...
def timed_signal(signal,target,x_limit_min,x_limit_max,y_limit_min,y_limit_max,data_points):
    ...
    plt.axvspan(5, 10, color='r', alpha=0.2, lw=0)
...
def main():
    ...
    feedback_signal=signal_3
    target_signal=target_3
    
    timed_signal(feedback_signal,target_signal,0,30,-2,2,data_test)
    timed_limit_cycle(feedback_signal,target_signal,-3,3,-3,3,data_test)
